...
Before writing any implementation code, you MUST follow this workflow for the entire conversation and obey all the rules in [DEVELOPMENT & IMPLEMENTATION RULES]:
